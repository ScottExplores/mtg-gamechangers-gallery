...
declare class Migrations extends MagicQuerier {
    all(page?: number): MagicEmitter<Migration, never>;
    byId(id: string): Promise<Migration>;
}
declare const _default: Migrations;
