...
declare class Catalog extends MagicQuerier {
    ...
    keywordAbilities(): Promise<string[]>;
    keywordActions(): Promise<string[]>;
    abilityWords(): Promise<string[]>;
    supertypes(): Promise<string[]>;
}
declare const _default: Catalog;
